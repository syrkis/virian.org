<script lang='ts'>
    ...
    let size: number = Math.min(window.innerWidth * 0.9, window.innerHeight * 0.8);
    $: height = size;
    $: width = size;
    ...
    const dims: array = 'self-enhancement;conservation;self-transcendence;spirituality;openness to change'.split(';');
    console.log(entries)
